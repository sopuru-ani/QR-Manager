...
function Overview() {
  ...
  transition-transform duration-300 md:relative md:translate-x-0 md:flex flex-col md:w-64`}
      >
        <button
        ...
        <div className="absolute bottom-4 left-4 md:hidden w-10 h-10 bg-lime text-white rounded-full flex items-center justify-center font-bold">
          SA
        </div>
        <div className="p-6">
          <h1 className="text-2xl font-bold text-lime mb-8">QR Manager</h1>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white shadow-md p-4 flex justify-between items-center md:ml-0">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="w-10 h-10 bg-lime text-white rounded-full flex items-center justify-center font-bold">
